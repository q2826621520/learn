...
var _ControlPanel = __webpack_require__(27);
...
var ControlPanel = function (_Component) {
	...
	function ControlPanel(props) {
		...
		_this.initValues = [0, 10, 20];
		//对初始值求和
		var initSum = _this.initValues.reduce(function (a, b) {
			return a + b;
		}, 0);
		//设置state为初始值得和
		_this.state = {
		...
		_this.onCounterUpdate = _this.onCounterUpdate.bind(_this);
		return _this;
	}
	...
	_createClass(ControlPanel, [{
		key: 'onCounterUpdate',
		value: function onCounterUpdate(newValue, previousValue) {
			var valueChange = newValue - previousValue;
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_Counter2.default, { onUpdate: this.onCounterUpdate, caption: ' \u4E00 ' })
				),
				_react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_Counter2.default, { onUpdate: this.onCounterUpdate, caption: ' \u4E8C ', initValue: this.initValues[1] })
				),
				_react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_Counter2.default, { onUpdate: this.onCounterUpdate, caption: ' \u4E09 ', initValue: this.initValues[2] })
				),
	...
	_createClass(Counter, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ onClick: this.onClickIncrementButton.bind(this) },
					'+'
				),
				_react2.default.createElement(
					'button',
					{ onClick: this.onClickDecrementButton.bind(this) },
					'-'
				),
				this.props.caption,
				this.state.count
