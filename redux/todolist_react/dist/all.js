...
var COMPLETE_TODO = exports.COMPLETE_TODO = 'COMPLETE_TODO'; //切换完成状态
var SET_VISIBILITY_FILTER = exports.SET_VISIBILITY_FILTER = 'SET_VISIBILITY_FILTER'; //设置显示类别
...
var _AddTodo = __webpack_require__(71);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          visibilityFilter = _props.visibilityFilter; //store中的数据

      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_AddTodo2.default
        //向子组件传入onAddClick回调函数,当子组件调用该函数时,向父组件传回数据
