...
//初始状态
var initialState = {
  visibilityFilter: _actionTypes.VisibilityFilters.SHOW_ALL,
  todos: []
};
...
// 4调度
store.dispatch({ type: _actionTypes.ADD_TODO, text: '11' }); //新增任务1
store.dispatch({ type: _actionTypes.ADD_TODO, text: '22' }); //新增任务2
store.dispatch({ type: _actionTypes.TOGGLE_TODO, index: 0 }); //切换任务1完成状态
store.dispatch({ type: _actionTypes.SET_VISIBILITY_FILTER, filter: _actionTypes.VisibilityFilters.SHOW_COMPLETED }); //显示已完成
...
var ADD_TODO = exports.ADD_TODO = 'ADD_TODO'; //添加
var TOGGLE_TODO = exports.TOGGLE_TODO = 'TOGGLE_TODO'; //切换完成状态
var SET_VISIBILITY_FILTER = exports.SET_VISIBILITY_FILTER = 'SET_VISIBILITY_FILTER'; //设置可见性
